...
/*
    HappyMeal - happymeal.io
    2% of every transaction is converted to BNB and sent to the Fund Address
    2% of every transaction is burned
    2% of every transaction is redistributed between holders of the coin
    # The percentage can be updated any time regarding the roadmap #
*/
...
contract HappyMeal is Context, IERC20, Ownable {
    ...
    address payable public FundAddress =
        0x7B0A37BcBD76D809541A89Db292eE6b08cE3FE01;
    ...
    function totalFundBNB() public view returns (uint256) {
        // BNB has  18 decimals!
        return _tFundTotal;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferETH(FundAddress, address(this).balance);
    }
